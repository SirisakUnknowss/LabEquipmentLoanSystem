...
urlpatterns = [
    ...
    path('user/list', baseViews.UserListPageView.as_view(), name='userListPage'),
    path('user/add', baseViews.AddUserView.as_view(), name='addUserPage'),
    ...
    path('equipment/cart', equipmentViews.CartPageView.as_view(), name='equipmentCartPage'),
    ...
    path('scientificInstrument/history', SLViews.BookingHistoryView.as_view(), name='bookingHistoryView'),
    ...
    path('chemicalSubstance/detail', CSViews.DetailPageView.as_view(), name='withdrawDetailPage'),
    ...
    path('chemicalSubstance/cart', CSViews.CartPageView.as_view(), name='chemicalSubstanceCartPage'),
    path('chemicalSubstance/notifications', CSViews.NotificationsPageView.as_view(), name='withdrawNotificationPage'),
