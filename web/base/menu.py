...
class MenuList(LabWebView):
    ...
    def setMenuHome(self) -> list:
        ...
        { 'name': 'ระบบการยืม-คืนวัสดุและอุปกรณ์วิทยาศาสตร์', 'link': 'equipment/list', 'image': 'static/images/landing/1.png' },
        { 'name': 'ระบบการจองใช้เครื่องมือวิทยาศาสตร์', 'link': 'scientificInstrument/list', 'image': 'static/images/landing/2.png' },
        { 'name': 'ระบบการเบิกสารเคมี', 'link': 'chemicalSubstance/list', 'image': 'static/images/landing/3.png' },
    ]
